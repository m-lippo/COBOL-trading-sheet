//TRADING2 JOB (SYS,SP,72664,09,30),'MATHEUS',NOTIFY=&SYSUID,
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
         DELETE (DES.SYS.MZ.BGT1.TRADE001) PURGE
         SET MAXCC=0
//*----------------------------------------------------------------*
//PT01     EXEC PGM=TRADING2
//TRADE001 DD   DSN=DES.SYS.MZ.BGT1.TRADE001,DISP=SHR
//STATS001 DD   DSN=DES.SYS.MZ.BGT1.STATS001,
